...
public class NodeJsLessCssCompiler {
  ...
  public NodeJsLessCssCompiler(boolean compress, String encoding, Log log) throws IOException {
    this("node", compress, encoding, log);
  }

  public NodeJsLessCssCompiler(String nodeExecutablePath, boolean compress,
